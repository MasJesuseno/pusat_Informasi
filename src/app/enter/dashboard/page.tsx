...
export default async function DashboardPage() {
  ...
  // Fetch all groups including INTERNAL (unlike public homepage)
  ...
  // Fetch recent articles for the grid display (shows both PUBLIC and INTERNAL)
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/80 text-sm mt-1">
                {locale === "id" ? "Manajemen Pengetahuan Internal" : "Internal Knowledge Management"}
              </p>
            </div>
      ...
      {/* Groups Section - like public homepage but includes INTERNAL */}
      {groups.length > 0 && (
      ...
      {/* My Collection - featured on main dashboard */}
      <section className="mb-8">
        <div
      ...
      <section className="mb-8">
        ...
        >
          ...
          <Link href="/enter/articles" className="text-sm text-white/80 hover:text-white transition-colors">&rarr; {locale === "id" ? "Lihat Semua" : "View All"}</Link>
        </div>
